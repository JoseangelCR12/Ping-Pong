...
data = {     
    ...
    "horizon_line" : 30, #Linea del horizonte, para el dibujado en pantalla con efecto pseudo 3D
...
def set_theme(new_theme: str):
    ...
    if new_theme in ["classic", "udo", "green", "neon"]:
...
def set_camera_preset(preset_name: str):
    presets = {
        ...
        "standard": {"horizon_line" : 0,  "camera_depth" : -200, "camera_height" : 304, "focal_length" : 456, "k_padding" : 228}
    }
