...
class Pseudo3D:
    """Modulo matematico de proyecciones de coordenadas y escalas para permitir el efecto 3D"""
    
    @staticmethod
    def world_to_screen(world_x: int, world_y: int, world_z: int):
        ...
        horizon_line = data["horizon_line"]
        camera_depth = data["camera_depth"]
        camera_height = data["camera_height"]
        focal_length = data["focal_length"]
        k_padding = data["k_padding"]
        ...
        vanishing_sx = config.WINDOW_WIDTH // 2
        screen_x = vanishing_sx + (world_x * scale) 
    ...
    @staticmethod
    def get_shadow_properties( world_z, base_scale, sprite_width, sprite_depth):
